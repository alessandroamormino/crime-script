    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-gradient-to-br from-red-900 to-gray-900 border border-red-600 rounded-lg p-8 mb-12 max-w-2xl">
          ...
          <button className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-lg text-lg font-semibold w-full transition">
            Acquista Serie Completa →
          </button>
                ...
                <div key={episodio.id} className="bg-gray-800 rounded-lg p-6 hover:bg-gray-750 transition">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="text-right ml-6">
                      ...
                      <button className="bg-gray-700 hover:bg-red-600 text-white px-6 py-2 rounded transition text-sm font-semibold">
                        Acquista
                      </button>
                    </div>
                  </div>
